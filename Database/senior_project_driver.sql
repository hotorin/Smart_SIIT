...
CREATE TABLE `driver` (
  ...
  `driver_username` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `driver` VALUES (1,'Driver Chief','driver_number1'),(2,'Driver','driver_number2'),(3,'Driver','driver_number3'),(4,'Driver','driver_number4');
